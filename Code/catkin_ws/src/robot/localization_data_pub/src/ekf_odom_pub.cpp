...
const double TICKS_PER_REVOLUTION = 496; // For reference purposes.
...
const double TICKS_PER_METER = 2340; // Original was 2800
...
int main(int argc, char **argv) {
  ...
  ros::Subscriber subForRightCounts = node.subscribe("wheel_right_ticks", 100, Calc_Right, ros::TransportHints().tcpNoDelay());
  ros::Subscriber subForLeftCounts = node.subscribe("wheel_left_ticks", 100, Calc_Left, ros::TransportHints().tcpNoDelay());
